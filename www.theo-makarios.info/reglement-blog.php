		...
		if (iAlert < 3)
		{
			...
			document.write(
				'<div class="ctn_z_infobox" style="margin: 0;font-size: 30px;" onclick="window.location = \'http://' + window.location.hostname + '/iphone/\';">' +
					...
					'</strong>' +
					'<br />' +
					'Overblog est disponible en version optimisée pour iPhone ! Touchez là !!' +
				'</div>'
			);
		}
	}
...
//]]>
  ...
  <span style="font-size: 24pt;">le blog de théo <b>makarios<br></b> <span style="font-size: 12pt;">est en travaux !</span></span>
  ...
  <h1>www.theo-makarios.info - conditions générales d'utilisation</h1>
  Informations pour ce site :<br />
  Adresse : www.theo-makarios.info  <p><blockquote>
    Titre : Le blog de Th&eacute;o Makarios    Description : L'actualité de l'Histoire vue par Théo Makarios, historien médiéviste et épigraphiste.    Ce site a été créé le 27/03/2005 
  </p></blockquote> 
  <p>
  Vous pouvez lire les <a href="http://www.over-blog.com/reglement-blog.php" class="newWindow">Conditions Générales d'Utilisation</a> du site www.theo-makarios.info.  </p>
	<p>
  Le site www.theo-makarios.info utilise le service over-blog.com et est hébergé par la société <a href="http://www.jfg-networks.com/" class="newWindow">JFG NETWORKS</a> dont le siège social est situé 1 Avenue Jean Rieux  - 31500 TOULOUSE.  <p>La société JFG Networks n'est pas responsable du contenu proposé par ce blog.</p>  </p>
 <p>
  Vous pouvez lire les <a href="http://www.over-blog.com/reglement.php" class="newWindow">conditions générales d'utilisation</a>, que l'auteur et responsable de ce blog a acceptées lors de son inscription  </p>
  	  Les thèmes suivants peuvent aussi vous intéresser :	  		<a href="http://www.over-blog.com/blog-annuaire-1-sport.html">Blog : Sport</a>&nbsp;
	...
	<div class="box-titre"><h2><span>Catégories</span></h2></div>
	<div class="box-content">
		<ul>
					<li>
				...
				<a href="http://www.theo-makarios.info/categorie-94277.html">Foires & Festivals</a>
					...
					<li>
				<a href="http://www.theo-makarios.info/categorie-71792.html">Actualités & Formations</a>
								(12)
							</li>
					<li>
				<a href="http://www.theo-makarios.info/categorie-94280.html">Expositions & Conférences</a>
								(14)
							</li>
					<li>
				...
				<a href="http://www.theo-makarios.info/categorie-95387.html">Entretiens</a>
					...
					<li>
				<a href="http://www.theo-makarios.info/categorie-102498.html">Cinéma, Musique & Vidéos</a>
								(6)
							</li>
					<li>
				<a href="http://www.theo-makarios.info/categorie-104839.html">Médias & Multimédia</a>
								(10)
							</li>
					<li>
						...
						<tbody>
							<tr>
								<td class="calendarDays1" align="left" style="width:25%">
																			<a href="http://www.theo-makarios.info/archive-2-7-2008.html" title="Article(s) du mois précédent">&lt;&lt;</a>
																	</td>
	...
	<div class="box-content">
		<ul>
			...
			<li>
				<a href="http://www.theo-makarios.info/article-7346439.html" title="Meilleurs vœux !">Meilleurs vœux !</a>
							</li>
			
			<li>
				<a href="http://www.theo-makarios.info/article-7321964.html" title="Le sapin de Noël">Le sapin de Noël</a>
							</li>
			
			<li>
				<a href="http://www.theo-makarios.info/article-7310140.html" title="Phœnix, détective du temps">Phœnix, détective du temps</a>
							</li>
			
			<li>
				<a href="http://www.theo-makarios.info/article-7308847.html" title="Elizabeth, l'âge d'or">Elizabeth, l'âge d'or</a>
							</li>
			...
			<li>
				<a href="http://www.theo-makarios.info/article-7303273.html" title="Le château de Suscinio (56)">Le château de Suscinio (56)</a>
							</li>
			...
			<li>
				<a href="http://www.theo-makarios.info/article-7288177.html" title="L'Histoire contemporaine à la carte">L'Histoire contemporaine à la carte</a>
							</li>
		...
		<span class="listAll"><a href="http://www.theo-makarios.info/articles-blog.html"><em>liste complète</em></a></span>
	</div>
	<div class="box-footer"><h2><span>&nbsp;</span></h2></div> 
</div>
  ...
  <div id="colbas3" class="colbas">
    ...
    <div class="colbas-content">
      <ul>
        ...
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://francoistonic.tooblog.fr/">François Tonic</a>
        </li>
        <li>
        ...
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://egypte.over-blog.com/">Dieux et Déesses d'Egypte</a>
        </li>
        <li>
        ...
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://gillesdubois.blogspot.com/">Carnet Web de Généalogie</a>
        </li>
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://pecia.tooblog.fr/">Le manuscrit médiéval</a>
        </li>
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://lir73.over-blog.com/">Les Indépendants Réunis</a>
        </li>
        <li>
        ...
        <li>
          <a class="lien" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;" href="http://chateau-espinasse.over-blog.com/">Château Espinasse</a>
        </li>
        <li>
	...
	>
		C.G.U.</a> -
			<a href='http://www.over-blog.com/offres-blog/rentabiliser-son-blog.php' class='newWindow'>Rémunération en droits d'auteur</a> avec <a href="http://www.tf1pub.fr/supports/communautaire/51.php" onclick="window.open(this); return false;" rel="nofollow">TF1 Network</a> -
